      ...
      <div className="container px-4 md:px-6">
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            ¡Tu consulta no molesta! Estamos disponibles para brindarte más información y ayudarte a
            planificar tu próxima estadía.
          </motion.p>
        </motion.div>

        {/* Grid de 2 columnas, alineación vertical al centro */}
