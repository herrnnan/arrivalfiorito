      ...
      <div className="container px-4 md:px-6">
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            ¡Tu consulta no molesta! Estamos disponibles para brindarte más información y ayudarte a planificar tu próxima estadía.
          </motion.p>
        </motion.div>

        {/* Grid de 2 columnas en pantallas grandes, con items alineados al tope */}
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          {/* Columna Derecha: Información de Contacto y Formulario */}
          <motion.div
...
// Define handleSubmit, handleChange y formData en el componente
